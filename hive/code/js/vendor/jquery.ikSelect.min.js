...
!function (a, b, c) {
    ...
    var e, f = a(b), g = {syntax: '<div class="ik_select_link"><div class="ik_select_link_text"></div></div><div class="ik_select_dropdown"><div class="ik_select_list"></div></div>', autoWidth: !0, ddFullWidth: !0, equalWidths: !0, dynamicWidth: !1, extractLink: !1, customClass: "", linkCustomClass: "", ddCustomClass: "", ddMaxHeight: 200, filter: !1, nothingFoundText: "Nothing found", isDisabled: !1, onShow: function () {
    }, onHide: function () {
    }, onKeyUp: function () {
    }, onKeyDown: function () {
    ...
    if (!a.browser) {
        var i = h(navigator.userAgent), j = {};
        i.browser && (j[i.browser] = !0, j.version = i.version), j.chrome ? j.webkit = !0 : j.webkit && (j.safari = !0), a.browser = j
    }
    a.browser.mobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile/i.test(navigator.userAgent), a.browser.operamini = "[object OperaMini]" === Object.prototype.toString.call(b.operamini), a.extend(d.prototype, {init: function () {
