...
const DownloadAndroid = (props) => {
  ...
  if (props.lang === 'ru') {
    return (
      <svg  xmlns="http://www.w3.org/2000/svg" width="135" height="40" viewBox="0 0 135 40" style={{fontWeight: 'normal'}}>
      ...
      <g xmlns="http://www.w3.org/2000/svg" id="design" stroke="none" strokeWidth="1" fill="none" fill-rule="evenodd">
        <g id="Android-download-eng" fillRule="nonzero">
          <g id="artwork">
            ...
            <path d="M47.4,10.2 C47.4,11 47.2,11.7 46.7,12.2 C46.1,12.8 45.4,13.1 44.5,13.1 C43.6,13.1 42.9,12.8 42.3,12.2 C41.7,11.6 41.4,10.9 41.4,10 C41.4,9.1 41.7,8.4 42.3,7.8 C42.9,7.2 43.6,6.9 44.5,6.9 C44.9,6.9 45.3,7 45.7,7.2 C46.1,7.4 46.4,7.6 46.6,7.9 L46.1,8.4 C45.7,7.9 45.2,7.7 44.5,7.7 C43.9,7.7 43.3,7.9 42.9,8.4 C42.4,8.8 42.2,9.4 42.2,10.1 C42.2,10.8 42.4,11.4 42.9,11.8 C43.4,12.2 43.9,12.5 44.5,12.5 C45.2,12.5 45.7,12.3 46.2,11.8 C46.5,11.5 46.7,11.1 46.7,10.6 L44.5,10.6 L44.5,9.9 L47.4,9.9 C47.4,9.9 47.4,10.1 47.4,10.2 Z" id="Shape" stroke="#FFFFFF" strokeWidth="0.2" fill="#FFFFFF"/>
            <polygon id="Shape" stroke="#FFFFFF" strokeWidth="0.2" fill="#FFFFFF" points="52 7.7 49.3 7.7 49.3 9.6 51.8 9.6 51.8 10.3 49.3 10.3 49.3 12.2 52 12.2 52 13 48.5 13 48.5 7 52 7"/>
            <polygon id="Shape" stroke="#FFFFFF" strokeWidth="0.2" fill="#FFFFFF" points="55.3 13 54.5 13 54.5 7.7 52.8 7.7 52.8 7 57 7 57 7.7 55.3 7.7"/>
            <polygon id="Shape" stroke="#FFFFFF" strokeWidth="0.2" fill="#FFFFFF" points="59.9 13 59.9 7 60.7 7 60.7 13"/>
            <polygon id="Shape" stroke="#FFFFFF" strokeWidth="0.2" fill="#FFFFFF" points="64.1 13 63.3 13 63.3 7.7 61.6 7.7 61.6 7 65.7 7 65.7 7.7 64 7.7 64 13"/>
            ...
            <polygon id="Shape" stroke="#FFFFFF" strokeWidth="0.2" fill="#FFFFFF" points="75.6 13 75.6 7 76.5 7 79.4 11.7 79.4 11.7 79.4 10.5 79.4 7 80.2 7 80.2 13 79.4 13 76.3 8.1 76.3 8.1 76.3 9.3 76.3 13"/>
