...
class DownloadAndroid extends React.Component {
  render() {
    ...
    const { lang, height, width } = this.props

    if (lang === 'ru') {
      return (
        <svg  xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox='0 0 135 40' style={{fontWeight: 'normal'}} className="market-btn-wrapper">
        ...
        <g xmlns="http://www.w3.org/2000/svg" id="design" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Android-download-eng" fillRule="nonzero">
            <g id="artwork">
              ...
              <g id="Group" transform="translate(10.000000, 7.000000)" fill="#FFFFFF" className="download-android_stroke">
...
DownloadAndroid.PropTypes = {
  lang: PropTypes.string,
  height: PropTypes.number,
  width: PropTypes.number
}

DownloadAndroid.defaultProps = {
  lang: 'ru',
  height: 40,
  width: 135
}
